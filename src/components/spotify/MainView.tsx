...
import { Play, ChevronLeft, ChevronRight, Bell, Users, Search, PanelLeft } from 'lucide-react';
...
export const MainView: React.FC = () => {
  const { playTrack, currentTrack, isPlaying, view, searchQuery, setSearchQuery, userTracks, toggleSidebar } = useSpotify();
  ...
  if (view === 'upload') {
    return (
      <div className="flex-1 bg-gradient-to-b from-zinc-800 to-zinc-950 flex flex-col overflow-hidden rounded-lg m-2 ml-0">
